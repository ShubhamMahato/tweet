...
public class ReasonConstant {
    public static final String firstNameNotValid="FIRST NAME NOT VALID";
    public static final String lastNameNotValid="LAST NAME NOT VALID";
    public static final String emailNotValid="EMAIL NOT VALID";
    public static final String dateNotValid="DATE NOT VALID";
